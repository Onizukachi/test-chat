...
%o`, message, error2, detail);
  ...
  // app/javascript/controllers/audio_notification_controller.js
  var audio_notification_controller_default = class extends Controller {
    static targets = ["audio"];
    connect() {
      console.log("Connected to Audio Notification controller");
    }
    playNotification() {
  ...
  application.register("audio-notification", audio_notification_controller_default);
  ...
  // app/javascript/channels/toast_channel.js
  consumer_default.subscriptions.create("ToastChannel", {
    connected() {
      console.log("dsadasdsadsadsds");
    },
    disconnected() {
    },
    received(data) {
